...
export const getSingleClasses = (type, tab, cssClassPrefix = '', bs) => {
    if (bs === 'bs4') {
        return getSingleClassesBs4(type, tab, cssClassPrefix);
    }
    return getSingleClassesBs5(type, tab, cssClassPrefix);
};
export const getSingleClassesBs5 = (type, tab, cssClassPrefix = '') => {
    ...
    return {
        ...
        and: (() => {
            ...
            const itemBox = (postfix) => `${itemWrapper(postfix)} .${cssClassPrefix}form-check.c-and-item-check`;
            return {
                box,
                switcherBox,
                switcher,
                ...
                itemWrapper,
                itemBox,
                itemControl: (postfix) => `${itemBox(postfix)} input.${cssClassPrefix}form-check-input.c-and-item-field`,
                itemLabel: (postfix) => `${itemBox(postfix)} label.${cssClassPrefix}form-check-label.c-and-item-label`,
            };
        })(),
        range: (() => {
...
export const getSingleClassesBs4 = (type, tab, cssClassPrefix = '') => {
    const { getCronType } = getSharedHelper(type);
    return {
        every: (() => {
