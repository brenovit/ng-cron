...
export const testDayQuartzTab = (code, contentSelector, schema, tabLink, exact = false) => {
    const { findInContainer } = getSharedHelper(code);
    const find = (selector) => findInContainer(`${contentSelector}[tab-name="${Type.DAY}"] ${selector}`);
    describe(Type.DAY, () => {
