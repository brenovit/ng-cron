...
export const getDayClasses = (type, cssClassPrefix = '', bs) => {
    if (bs === 'bs4') {
        return getDayClassesBs4(type, cssClassPrefix);
    }
    return getDayClassesBs5(type, cssClassPrefix);
};
export const getDayClassesBs5 = (type, cssClassPrefix = '') => {
    ...
    return {
        ...
        andWeekday: (() => {
            ...
            const itemWrapper = (postfix) => `${itemsBox} .${cssClassPrefix}col-3.${cssClassPrefix}col-md-2.c-and-weekday-item${postfix}`;
            const itemBox = (postfix) => `${itemWrapper(postfix)} .${cssClassPrefix}form-check.c-and-weekday-item-check`;
            return {
                box,
                switcherBox,
                switcher,
                ...
                itemWrapper,
                itemBox,
                itemControl: (postfix) => `${itemBox(postfix)} input.${cssClassPrefix}form-check-input.c-and-weekday-item-field`,
                itemLabel: (postfix) => `${itemBox(postfix)} label.${cssClassPrefix}form-check-label.c-and-weekday-item-label`,
            };
        })(),
        andMonthday: (() => {
            ...
            const itemWrapper = (postfix) => `${itemsBox} .${cssClassPrefix}col-2.${cssClassPrefix}col-md-1.c-and-monthday-item${postfix}`;
            const itemBox = (postfix) => `${itemWrapper(postfix)} .${cssClassPrefix}form-check.c-and-monthday-item-check`;
            return {
                box,
                switcherBox,
                switcher,
                ...
                itemWrapper,
                itemBox,
                itemControl: (postfix) => `${itemBox(postfix)} input.${cssClassPrefix}form-check-input.c-and-monthday-item-field`,
                itemLabel: (postfix) => `${itemBox(postfix)} label.${cssClassPrefix}form-check-label.c-and-monthday-item-label`,
            };
        })(),
        lastMonthday: (() => {
...
export const getDayClassesBs4 = (type, cssClassPrefix = '') => {
    const { getCronType } = getSharedHelper(type);
    return {
        everyWeekday: (() => {
